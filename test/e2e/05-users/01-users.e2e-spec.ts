...
describe('Device Controller (e2e)', () => {
  ...
  const adminSystemToken =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjA1NTVmNmI1LWM3MjQtNDVhNi04N2NmLTk1Nzg2ZWIyYTAyMCIsInJvbGUiOiJBZG1pbiBTeXN0ZW0iLCJpYXQiOjE3NDY5NDU5NjJ9.Kzb7szg3rNmzX-UtBsxO02_9K1BcrbnLuPQtKP4Aj6I';
  ...
  const localMemberToken =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImU1YjkxZGM5LWI1ZDAtNGJmNy1iYmJhLWQ3Yjg3Mjc0NGVjNyIsInJvbGUiOiJMb2thbCBNZW1iZXIiLCJpYXQiOjE3NDc1NjAyODZ9.5cbRObBonOyiNS9e2M0KMc0e88bvZ2Dha8e9iIkDCyQ';
  ...
  it('successfully get users by id', async () => {
    const res = await request(app.getHttpServer())
      .get(`${apiVersion}/users/da50de59-1f67-4007-ab33-3de8d08825b9`)
  ...
  it('successfully get users search', async () => {
    const res = await request(app.getHttpServer())
      .get(`${apiVersion}/users/search?identity=`)
      .set('Authorization', `Bearer ${adminSystemToken}`);
