...
export class OrganizationsRestApiController {
  ...
  @ApiOperation({
    summary: 'Get user organizations list (local member minimal role)',
  })
  @ApiOkResponse({
    schema: {
      example: {
  ...
  @ApiOperation({
    summary: 'Propose an organization (regular user minimal role)',
  })
  @ApiOkResponse({
    schema: {
      example: {
        message:
          'Organization proposed successfully, please contanct admin system for verification.',
        data: {
  ...
  async postPropose(
    ...
    @Body() postProposeDto: dto.PostProposeDto,
  ) {
    this.logger.log(`There is a request to propose an organization`);
    return this.organizationsRestApiService.postPropose(
      request.user.id,
      postProposeDto,
    );
  }
  ...
  @ApiOperation({
    summary: 'Unverify organization (admin system minimal role)',
  })
  @ApiOkResponse({
    schema: {
      example: {
  ...
  @ApiOperation({
    summary: 'Get organization profile (organization viewer minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  async getOrganizationProfile(@Req() request: AuthenticatedRequest) {
    ...
    return this.organizationsRestApiService.getOrganizationProfile(
      request.user.id,
  ...
  @ApiOperation({
    summary: 'Update organization profile (organization admin minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
    ...
    schema: {
      example: {
        ...
        data: {
          ...
          organization_picture:
            'http://localhost:3000/uploads/organization_picture/1745810588643-360135057.png',
          location: null,
        },
      },
    },
  ...
  async patchOrganizationProfile(
    @Req() request: AuthenticatedRequest,
    @Body() patchOrganizationProfileDto: dto.PatchOrganizationProfileDto,
  ) {
    this.logger.log(`There is a request to update organization profile`);
    return this.organizationsRestApiService.patchOrganizationProfile(
      request,
      request.params.organizationId,
      patchOrganizationProfileDto,
  ...
  @ApiOperation({
    summary: 'Member invitation (organization admin minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  async postAddMember(
    @Req() request: AuthenticatedRequest,
    @Body() postMemberInvitationDto: dto.PostMemberInvitationDto,
  ) {
    this.logger.log(`There is a request to invite member`);
    return this.organizationsRestApiService.postMemberInvitation(
      request.params.organizationId,
      postMemberInvitationDto,
    );
  }

  @ApiOperation({
    summary: 'Member invitation response (regular user minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  @UseGuards(UserRolesGuard)
  @UserRoles(UserRole.REGULAR_USER)
  async patchMemberInvitationResponse(
    @Req() request: AuthenticatedRequest,
    @Body() patchInvitationResponseDto: dto.PatchInvitationResponseDto,
  ) {
    this.logger.log(
      `There is a request to accept or reject invitation to join organization`,
    );
    return this.organizationsRestApiService.patchMemberInvitationResponse(
      request.user.id,
      request.params.organizationId,
      patchInvitationResponseDto,
    );
  }

  @ApiOperation({
    summary: 'Create local member (organization admin minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  @UseGuards(OrganizationMemberRolesGuard)
  @OrganizationMemberRoles(OrganizationMemberRole.ADMIN)
  async postLocalMember(
    @Req() request: AuthenticatedRequest,
    @Body() localMemberDto: dto.PostLocalMemberDto,
  ) {
    this.logger.log(`There is a request to create local member`);
    return this.organizationsRestApiService.postLocalMember(
      request.params.organizationId,
      localMemberDto,
    );
  }
  ...
  @ApiOperation({
    summary: 'Get member list (organization viewer minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  async getMemberList(@Req() request: AuthenticatedRequest) {
    ...
    return this.organizationsRestApiService.getMemberList(
      request.params.organizationId,
    );
  }

  @ApiOperation({
    summary: 'Change member roles (organization admin minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  async patchMemberRoles(
    @Req() request: AuthenticatedRequest,
    @Body() patchMemberRolesDto: dto.PatchMemberRolesDto,
  ) {
    this.logger.log(`There is a request to change member roles`);
    return this.organizationsRestApiService.patchMemberRoles(
      request.params.organizationId,
      patchMemberRolesDto,
    );
  }
  ...
  async deleteMember(@Req() request: AuthenticatedRequest) {
    ...
    return this.organizationsRestApiService.deleteMember(
      request.params.organizationId,
  ...
  @ApiOperation({
    summary: 'Leave organization (organization viewer minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
  ...
  async deleteLeave(@Req() request: AuthenticatedRequest) {
    ...
    return this.organizationsRestApiService.deleteLeave(
      request.user.id,
      request.params.organizationId,
    );
  }
  ...
  @ApiOperation({
    summary: 'Get organization by id (admin system minimal role)',
  })
  @ApiParam({
    name: 'organizationId',
    type: String,
