...
@Controller('api/v1/organizations/:organizationId/devices')
export class DevicesRestApiController {
  private readonly logger = new Logger(DevicesRestApiController.name);
  constructor(private readonly devicesRestApiService: DevicesRestApiService) {}

  @ApiOperation({
    summary: 'Create a new device (organization operator minimal role)',
  })
  @ApiOkResponse({
    schema: {
      example: {
  ...
  async post(
    ...
    @Body() postDto: dto.PostDto,
  ) {
    this.logger.log(`There is a request to create an device`);
    return this.devicesRestApiService.post(
  ...
  @ApiOperation({
    summary: 'Search devices (organization viewer minimal role)',
  })
  @ApiOkResponse({
    schema: {
      example: {
  ...
  async getSearch(
    ...
    return this.devicesRestApiService.getSearch(
      request.params.organizationId,
      query,
    );
  }
  ...
  @ApiOperation({
    summary: 'Get device by id (organization viewer minimal role)',
  })
  ...
  async get(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.get(
      request.params.organizationId,
  ...
  @ApiOperation({
    summary: 'Update device (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  async patch(
    @Req() request: AuthenticatedRequest,
    @Body() patchDto: dto.PatchDto,
  ) {
    this.logger.log(`There is a request to update device`);
    return this.devicesRestApiService.patch(
      request.params.organizationId,
      request.params.deviceId,
      patchDto,
    );
  ...
  @ApiOperation({
    summary: 'Delete device (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  @ApiOperation({
    summary: 'Create or update widget box (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  async putWidgetBox(
    @Req() request: AuthenticatedRequest,
    @Body() putWidgetBoxDto: dto.PutWidgetBoxDto,
  ) {
    this.logger.log(`There is a request to create or update widget box`);
    return this.devicesRestApiService.putWidgetBox(
      request.params.organizationId,
      request.params.deviceId,
      putWidgetBoxDto,
    );
  ...
  @ApiOperation({
    summary: 'Get widget box list (organization viewer minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  async getWidgetBoxesList(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.getWidgetBoxesList(
      request.params.organizationId,
      request.params.deviceId,
    );
  }
  ...
  @ApiOperation({
    summary: 'Get widget box by id (organization viewer minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  ...
  async getWidgetBox(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.getWidgetBox(
      request.params.organizationId,
      request.params.deviceId,
      request.params.widgetBoxId,
    );
  }

  @ApiOperation({
    summary: 'Delete widget box (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiParam({ name: 'widgetBoxId', type: String, description: 'Widget box id' })
  @ApiOkResponse({
  ...
  async deleteWidgetBox(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.deleteWidgetBox(
      request.params.organizationId,
      request.params.deviceId,
      request.params.widgetBoxId,
    );
  ...
  @ApiOperation({
    summary: 'Get device report (organization viewer minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  async getReport(
    ...
    return this.devicesRestApiService.getReport(
      request.params.organizationId,
      request.params.deviceId,
      pin,
      start,
  ...
  @ApiOperation({
    summary: 'Create notification events (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  @UseGuards(OrganizationMemberRolesGuard)
  @OrganizationMemberRoles(OrganizationMemberRole.OPERATOR)
  async postNotificationEvent(
    @Req() request: AuthenticatedRequest,
    @Body() postNotificationEvent: dto.PostNotificationEventDto,
  ) {
    this.logger.log(`There is a request to create notification events`);
    return this.devicesRestApiService.postNotificationEvent(
      request.params.organizationId,
      request.params.deviceId,
  ...
  @ApiOperation({
    summary: 'Get notification events list (organization viewer minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiOkResponse({
    schema: {
  ...
  async getNotificationEventsList(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.getNotificationEventsList(
      request.params.organizationId,
      request.params.deviceId,
    );
  }
  ...
  @ApiOperation({
    summary: 'Get notification events by id (organization viewer minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiParam({
  ...
  async getNotificationEvent(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.getNotificationEvent(
      request.params.organizationId,
      request.params.deviceId,
      request.params.notificationEventId,
    );
  }

  @ApiOperation({
    summary: 'Update notification events (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiParam({
    name: 'notificationEventId',
  ...
  @UseGuards(OrganizationMemberRolesGuard)
  @OrganizationMemberRoles(OrganizationMemberRole.OPERATOR)
  async patchNotificationEvent(
    @Req() request: AuthenticatedRequest,
    @Body() patchNotificationEvent: dto.PatchNotificationEventDto,
  ) {
    this.logger.log(`There is a request to update notification events`);
    return this.devicesRestApiService.patchNotificationEvent(
      request.params.organizationId,
      request.params.deviceId,
      request.params.notificationEventId,
  ...
  @ApiOperation({
    summary: 'Delete notification events (organization operator minimal role)',
  })
  @ApiParam({ name: 'deviceId', type: String, description: 'Device id' })
  @ApiParam({
    name: 'notificationEventId',
  ...
  async deleteNotificationEvent(@Req() request: AuthenticatedRequest) {
    ...
    return this.devicesRestApiService.deleteNotificationEvent(
      request.params.organizationId,
      request.params.deviceId,
      request.params.notificationEventId,
    );
